...
interface CollectionManager<T> {
     ...
     */
    fun updateElementByID(item: T, authorId: Int) : Boolean

    /**
     * Очистить коллекцию.
     */
    fun clear(authorId: Int)
     ...
     */
    fun removeElementByID(id: Int, authorId: Int) : Boolean
     ...
     * @return true при успешном удалении, false при ошибке.
     */
    fun removeLowerThen(item: T, authorId: Int) : Boolean
