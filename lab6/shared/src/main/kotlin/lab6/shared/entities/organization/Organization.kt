...
import lab6.shared.entities.CorrectnessException
import lab6.shared.entities.Entity
...
data class Organization(
    ...
    @Serializable(with = LocalDateSerializer::class)  val creationDate: LocalDate = LocalDate.now(),
    @XmlElement
